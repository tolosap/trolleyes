moduloDirectivas.component('foreignKey2', {
    templateUrl: "js/system/component/foreignkey/foreignkey2.html",
    controllerAs: 'fk',
    controller: foreignkeyController12,
    bindings: {
        "bean": "=",
        "form": "=",
        "name": "<",
...
function foreignkeyController12(toolService, serverCallService, $uibModal) {
    var self = this;
    //-----
